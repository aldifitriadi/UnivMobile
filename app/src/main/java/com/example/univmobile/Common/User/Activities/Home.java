...
import com.example.univmobile.Common.User.Activities.Mahasiswa.SettingsActivity;
import com.example.univmobile.Common.User.Fragments.HomeFragment;
import com.example.univmobile.Common.User.Fragments.MahasiswaFragment;
import com.example.univmobile.Common.User.Fragments.ProfileFragment;
import com.example.univmobile.Common.User.Models.Post;
...
//        return super.onOptionsItemSelected(item);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            fab.setVisibility(View.INVISIBLE);
            getSupportFragmentManager().beginTransaction().replace(R.id.container, new MahasiswaFragment()).commit();
...
//                usersData = dataSnapshot.getValue(UserHelperClass.class);
//                assert usersData != null;
//                navUserMail.setText(usersData.getNim());
//            }
//            @Override
